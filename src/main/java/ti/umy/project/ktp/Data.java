...
public class Data implements Serializable {
    ...
    public Data(Long id, String noktp, String nama, String jeniskelamin, String alamat, String agama, String status, String kewarganegaraan) {
        this.id = id;
        this.noktp = noktp;
        this.nama = nama;
    ...
    public String toString() {
        return "ti.umy.project.ktp.Data[ id=" + id + " ]";
    }
