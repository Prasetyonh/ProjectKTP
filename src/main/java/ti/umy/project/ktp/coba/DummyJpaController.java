...
import ti.umy.project.ktp.coba.exceptions.NonexistentEntityException;
import ti.umy.project.ktp.coba.exceptions.PreexistingEntityException;
...
public class DummyJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("ti.umy_project.ktp_jar_0.0.1-SNAPSHOTPU");
